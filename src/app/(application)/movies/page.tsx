    ...
    return (
        <main className="w-full flex flex-col grow items-center">
            ...
            <div className="flex flex-wrap gap-4 w-11/12 justify-center sm:justify-start *:hover:cursor-pointer">
                <Link href="/movies/recommended" className="bg-slate-900/75 backdrop-blur-xl shadow-lg rounded-lg h-64 w-52 p-2 flex flex-col justify-between">
                ...
                <Link href="/movies/saved" className="bg-slate-900/75 backdrop-blur-xl shadow-lg rounded-lg h-64 w-52 p-2 flex flex-col justify-between">
                ...
                <Link href="/movies/liked" className="bg-slate-900/75 backdrop-blur-xl shadow-lg rounded-lg h-64 w-52 p-2 flex flex-col justify-between">
                ...
                <Link href="/movies/disliked" className="bg-slate-900/75 backdrop-blur-xl shadow-lg rounded-lg h-64 w-52 p-2 flex flex-col justify-between">
