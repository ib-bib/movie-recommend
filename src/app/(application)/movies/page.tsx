...
export default async function YourMovies() {
    return (
        <main className="w-full flex flex-col grow items-center">
            ...
            <div className="flex flex-wrap gap-4 w-11/12 justify-center sm:justify-start">
                <div className="bg-slate-900/75 backdrop-blur-xl shadow-lg rounded-lg h-64 w-52 p-2 flex flex-col justify-between">
